...
async function main() {
  ...
  const defaultConfigs = [
    ...
    {
      key: 'LOCATION_ACCURACY_THRESHOLD',
      value: '50',
      description: 'Minimum required GPS accuracy in meters',
      category: 'location'
    },
    {
      key: 'LOCATION_UPDATE_INTERVAL_MS',
      value: '1000',
    ...
    {
      key: 'AUDIO_CHUNK_SIZE_KB',
      value: '64',
      description: 'Audio chunk size for streaming in kilobytes',
      category: 'audio'
    },
    {
      key: 'AUDIO_QUALITY',
      value: 'medium',
      description: 'Audio recording quality (low, medium, high)',
      category: 'audio'
    },
